...
@section('content')
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Create New Employee</h1>
            <p class="mt-2 text-gray-600">Add a new employee to the system</p>
        </div>
                ...
                @else
                    ...
                    <div>
                        ...
                        <div class="px-3 py-2 bg-gray-50 border border-gray-300 rounded-md">
                            <span class="text-gray-900">{{ $companies->first()->name }}</span>
                        </div>
